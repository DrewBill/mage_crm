...
import com.mage.crm.service.CustomerServerService;
...
public class CustomerServerController extends BaseController {
    ...
    public MessageModel insert(CustomerServe customerServe){
        customerServerService.insert(customerServe);
    ...
    public Map<String,Object> queryCustomerServesByParams(CustomerServeQuery customerServeQuery){
        return customerServerService.queryCustomerServesByParams(customerServeQuery);
    }

    @ResponseBody
    @RequestMapping("update")
    public MessageModel update(CustomerServe customerServe, HttpServletRequest request){
        customerServerService.update(customerServe,request);
    ...
    public Map<String,Object> queryCustomerServeType(){
        return customerServerService.queryCustomerServeType();
    }
}
