...
public class CustomerService {
    ...
    public void delete(Integer[] id) {
        AssertUtil.isTrue(customerDao.delete(id)<id.length,"所选客户记录删除失败");
    }

    public Customer queryAllCustomerById(Integer id) {
        Customer customer = customerDao.queryCustomersByParamId(id);
        return customer;
    }
